...
extern char *utf16ntoascii(char *__restrict __dest, const char *__restrict __src, size_t size)
	__attribute__((nonnull(1, 2)));

extern char *asciintoutf16(char *__restrict __dest, const char *__restrict __src, size_t size)
	__attribute__((nonnull(1, 2)));
